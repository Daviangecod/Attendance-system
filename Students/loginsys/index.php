  ...
  <main class="min-h-screen bg-blue-950 px-5 md:px-0">
    ...
    <div class="container mx-auto min-h-screen flex flex-col gap-4 items-center justify-center">
        ...
        <?php if(isset($_GET['error'])): ?>
            ...
            <?php if($_GET['error'] == "invalidcredentials"): ?>
                <div class="rounded-lg bg-red-100 text-red-500 border border-red-500 py-3 px-2 text-center w-[500px]">
                    Invalid Credentials
                </div>
            <?php endif ?>

            <?php if($_GET['error'] == "accessfailed"): ?>
                <div class="rounded-lg bg-red-100 text-red-500 border border-red-500 py-3 px-2 text-center w-[500px]">
                    You can't access that page at the moment
                </div>
            <?php endif ?>
        ...
        <?php if($_GET['success'] == "logoutsuccess"): ?>
        ...
        <form action="./action/authenticate.php" method="POST" class="bg-white shadow w-[500px] min-h-[280px] rounded-lg py-3 px-5">

            <h3 class="mb-5 text-3xl font-semibold text-center">Login</h3>
            ...
            <button type="submit" class="w-full py-3 px-2 bg-blue-800 hover:bg-blue-900 text-white rounded transition-all delay-75 ease-in-out">Login</button>
        </form>
