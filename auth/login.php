    ...
    <div class="container mx-auto">
        ...
        <h1 class="text-3xl font-semibold mb-8 text-center">Login to your account</h1>
            ...
            <form action="<?= baseUrl('auth/action/authenticate.php') ?>" method="POST">
                ...
                <button type="submit" class="py-3 px-2 bg-blue-700 text-white hover:bg-primary-dark w-full rounded-lg transition-all delay-75 ease-in-out mb-5">Login</button>
